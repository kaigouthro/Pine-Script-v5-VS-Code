...
public class PineScriptColorSettingsPage implements ColorSettingsPage {
    ...
    public ColorDescriptor[] getColorDescriptors() {
        return new ColorDescriptor[]{new ColorDescriptor("Selection Background", com.intellij.openapi.editor.colors.EditorColors.SELECTION_BACKGROUND_COLOR, ColorDescriptor.Kind.BACKGROUND)};
    }
